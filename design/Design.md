...
| File Name | Source Name | Source ID       |                    |                             | Tag Type ID      | Hash Type Name | Hash Type ID | Times Accessed | Creation Date      | Image Pixel Count  | Image ID | File ID           | File ID              | Video Duration     | Audio Duration  | Song Title | Band ID    | Band Name | Artist ID    | Artist First Name  | Album ID          | Song Lyrics | File ID        | Music Genre Name | Album Name | Book Title      | File ID          | Language Code | Literary Publisher ID | Literary Publisher Name | Literary Genre ID | Literary Genre Name | Author Name ID | Author First Name  | Folder View Type |
| File Path |             | File ID         |                    |                             |                  |                | File ID      |                | Last Updated Date  | Image Width        |          | Date Taken        | Latitude             | Video Width        | Audio Frequency |            |            |           |              | Artist Middle Name | File ID           |             | Music Genre ID |                  |            | Book Page Count | Language ID      | Language Name | Book Publish Date     |                         |                   |                     |                | Author Middle Name |                  |
