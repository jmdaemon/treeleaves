...
| Files     | Sources     | Source Tag Sets | Source Tags | Hash Sets           | Hashes      | Frequency      | Timestamps         | Images            | Photos         | Videos         | Audio           | Songs         | Song Track        | Song Lyrics | Song Genres     | Album           | Books           | Book Languages | Book Publishers     | Book Genres     | Book Authors   | Author Name        | Folders          |
|-----------|-------------|-----------------|-------------|---------------------|-------------|----------------|--------------------|-------------------|----------------|----------------|-----------------|---------------|-------------------|-------------|-----------------|-----------------|-----------------|----------------|---------------------|-----------------|----------------|--------------------|------------------|
| File Name | Source Name | Source ID       | File ID     | File ID             | Hash Set ID | Times Accessed | Creation Date      | Image Pixel Count | GPS Location   | Video Duration | Audio Duration  | Song Duration | Song Album ID     | Song ID     | File ID         | Album ID        | Book Title      | Book ID        | Book ID             | Book ID         | Book ID        | Author First Name  | Times Accessed   |
| File Path | Source URL  | Tag Set Name    | Tag Name    | Hash Algorithm Name | File Hash   |                | Last Updated Date  | Image Width       | Date Timestamp | Video Width    | Audio Frequency | Song Artist   | Song ID           | Song Lyrics | Song Genre Name | Song Album Name | Book Page Count | Book Language  | Book Publisher Name | Book Genre Name | Author Name ID | Author Middle Name | Folder Name      |
| MIME Type |             |                 |             |                     |             |                | Last Accessed Date | Image Height      |                | Video Height   |                 | Song Title    | Song Track Number |             |                 |                 |                 |                | Book Publish Date   |                 |                | Author Last Name   | Folder View Type |
| File Size |             |                 |             |                     |             |                |                    |                   |                |                |                 |               |                   |             |                 |                 |                 |                |                     |                 |                |                    |                  |
|           |             |                 |             |                     |             |                |                    |                   |                |                |                 |               |                   |             |                 |                 |                 |                |                     |                 |                |                    |                  |
|           |             |                 |             |                     |             |                |                    |                   |                |                |                 |               |                   |             |                 |                 |                 |                |                     |                 |                |                    |                  |
|           |             |                 |             |                     |             |                |                    |                   |                |                |                 |               |                   |             |                 |                 |                 |                |                     |                 |                |                    |                  |
