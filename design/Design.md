...
| Files     | Sources           | Source Tags | Hashes    | Frequency      | Timestamps         | Images            | Photos         | Videos         | Audio           | Songs             | Books             | Book Authors   | Author Name        | Folders          |
|-----------|-------------------|-------------|-----------|----------------|--------------------|-------------------|----------------|----------------|-----------------|-------------------|-------------------|----------------|--------------------|------------------|
| File Name | Source Name       | File ID     | Hash Type | Times Accessed | Creation Date      | Image Pixel Count | GPS Location   | Video Duration | Audio Duration  | Song Duration     | Book Authors ID   | Book ID        | Author First Name  | Times Accessed   |
| File Path | Source URL        | Tag Name    | File Hash |                | Last Updated Date  | Image Width       | Date Timestamp | Video Width    | Audio Frequency | Song Artist       | Book Title        | Author Name ID | Author Middle Name | Folder View Type |
| MIME Type | Source Tag Set ID |             |           |                | Last Accessed Date | Image Height      |                | Video Height   |                 | Song Album Name   | Book Genre        |                | Author Last Name   |                  |
