...
|-----------|-------------|-----------------|--------------------|-----------------------------|------------------|----------------|-------------|----------------|--------------------|--------------------|----------|-------------------|----------------------|--------------------|-----------------|------------|------------|-----------|--------------|--------------------|-------------------|-------------|----------------|------------------|------------|-----------------|------------------|---------------|-----------------------|-------------------------|-------------------|---------------------|----------------|--------------------|------------------|
| File ID   | Source ID   | File ID         | Source Tag Type ID | `Tag Type Table Definition` | File ID          | Hash Type ID   | File ID     | File ID        | File ID            | File ID            | Photo ID | Photo Metadata ID | Location Metadata ID | File ID            | File ID         | File ID    | File ID    | Band ID   | File ID      | Artist ID          | Song Track ID     | File ID     | Song Genre ID  | Music Genre ID   | Album ID   | File ID         | Book Language ID | Language ID   | File ID               | Literary Publisher ID   | File ID           | Literary Genre ID   | File ID        | Author ID          | File ID          |
