...
| Files     | Source Sets     | Sources    | Source Tag Sets   | Source Tags   | Hash Sets           | Hashes      | Frequency      | Timestamps         | Images            | Photos   | Photo Metadata    | Location Metadata    | Videos         | Audio           | Songs         | Song Track        | Song Lyrics    | Song Genres     | Album           | Books           | Book Languages   | Book Publishers     | Book Genres     | Book Authors    | Author Name        | Folders          |
|-----------|-----------------|------------|-------------------|---------------|---------------------|-------------|----------------|--------------------|-------------------|----------|-------------------|----------------------|----------------|-----------------|---------------|-------------------|----------------|-----------------|-----------------|-----------------|------------------|---------------------|-----------------|-----------------|--------------------|------------------|
| File ID   | Source Set ID   | Source ID  | Source Tag Set ID | Source Tag ID | Hash Set ID         | Hash ID     | Frequency ID   | Timestamp ID       | Image ID          | Photo ID | Photo Metadata ID | Location Metadata ID | Video ID       | Audio ID        | Song ID       | Song Track ID     | Song Lyrics ID | Song Genre ID   | Album ID        | Book ID         | Book Language ID | Book Publisher ID   | Book Genre ID   | Book Authors ID | Author ID          | Folder ID        |
| File Name | Source Set Name | File ID    | Source ID         | File ID       | File ID             | Hash Set ID | File ID        | File ID            | File ID           | Image ID | Photo ID          | Photo ID             | Video Duration | Audio Duration  | Audio ID      | Song Album ID     | Song ID        | File ID         | Song Album Name | Book Title      | Book ID          | Book ID             | Book ID         | Book ID         | Author First Name  | Folder Name      |
| File Path |                 | Source URL | Tag Set Name      | Tag Name      | Hash Algorithm Name | File Hash   | Times Accessed | Creation Date      | Image Pixel Count |          | Date Taken        | Latitude             | Video Width    | Audio Frequency | Song Duration | Song ID           | Song Lyrics    | Song Genre Name |                 | Book Page Count | Book Language    | Book Publisher Name | Book Genre Name | Author Name ID  | Author Middle Name | Folder Path      |
| MIME Type |                 |            |                   |               |                     |             |                | Last Updated Date  | Image Width       |          | Time Taken        | Longitude            | Video Height   |                 | Song Artist   | Song Track Number |                |                 |                 |                 |                  | Book Publish Date   |                 |                 | Author Last Name   | Folder View Type |
| File Size |                 |            |                   |               |                     |             |                | Last Accessed Date | Image Height      |          |                   |                      |                |                 | Song Title    |                   |                |                 |                 |                 |                  |                     |                 |                 |                    | Times Accessed   |
|           |                 |            |                   |               |                     |             |                |                    |                   |          |                   |                      |                |                 |               |                   |                |                 |                 |                 |                  |                     |                 |                 |                    |                  |
|           |                 |            |                   |               |                     |             |                |                    |                   |          |                   |                      |                |                 |               |                   |                |                 |                 |                 |                  |                     |                 |                 |                    |                  |
