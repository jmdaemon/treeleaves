...
| Files     | Sources     | Source Tag Sets | Source Tags | Hashes    | Frequency      | Timestamps         | Images            | Photos         | Videos         | Audio           | Songs         | Song Track        | Song Lyrics | Song Genres     | Album           | Books           | Book Languages | Book Publishers     | Book Genres     | Book Authors   | Author Name        | Folders          |
|-----------|-------------|-----------------|-------------|-----------|----------------|--------------------|-------------------|----------------|----------------|-----------------|---------------|-------------------|-------------|-----------------|-----------------|-----------------|----------------|---------------------|-----------------|----------------|--------------------|------------------|
| File Name | Source Name | Source ID       | File ID     | Hash Type | Times Accessed | Creation Date      | Image Pixel Count | GPS Location   | Video Duration | Audio Duration  | Song Duration | Song Album ID     | Song ID     | File ID         | Album ID        | Book Title      | Book ID        | Book ID             | Book ID         | Book ID        | Author First Name  | Times Accessed   |
| File Path | Source URL  | Tag Set Name    | Tag Name    | File Hash |                | Last Updated Date  | Image Width       | Date Timestamp | Video Width    | Audio Frequency | Song Artist   | Song ID           | Song Lyrics | Song Genre Name | Song Album Name | Book Page Count | Book Language  | Book Publisher Name | Book Genre Name | Author Name ID | Author Middle Name | Folder Name      |
