...
| Files     | Sources           | Source Tags | Hashes    | Frequency      | Timestamps         | Images            | Photos         | Videos         | Audio           | Songs         | Song Track        | Song Lyrics | Song Genres     | Album           | Books             | Book Authors   | Author Name        | Folders          |
|-----------|-------------------|-------------|-----------|----------------|--------------------|-------------------|----------------|----------------|-----------------|---------------|-------------------|-------------|-----------------|-----------------|-------------------|----------------|--------------------|------------------|
| File Name | Source Name       | File ID     | Hash Type | Times Accessed | Creation Date      | Image Pixel Count | GPS Location   | Video Duration | Audio Duration  | Song Duration | Song Album ID     | Song ID     | File ID         | Album ID        | Book Authors ID   | Book ID        | Author First Name  | Times Accessed   |
| File Path | Source URL        | Tag Name    | File Hash |                | Last Updated Date  | Image Width       | Date Timestamp | Video Width    | Audio Frequency | Song Artist   | Song ID           | Song Lyrics | Song Genre Name | Song Album Name | Book Title        | Author Name ID | Author Middle Name | Folder View Type |
| MIME Type | Source Tag Set ID |             |           |                | Last Accessed Date | Image Height      |                | Video Height   |                 | Song Title    | Song Track Number |             |                 |                 | Book Genre        |                | Author Last Name   |                  |
| File Size |                   |             |           |                |                    |                   |                |                |                 |               |                   |             |                 |                 | Book Publisher    |                |                    |                  |
|           |                   |             |           |                |                    |                   |                |                |                 |               |                   |             |                 |                 | Book Publish Date |                |                    |                  |
|           |                   |             |           |                |                    |                   |                |                |                 |               |                   |             |                 |                 | Book Language     |                |                    |                  |
|           |                   |             |           |                |                    |                   |                |                |                 |               |                   |             |                 |                 | Book Page Count   |                |                    |                  |
